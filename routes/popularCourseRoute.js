...
const { createPopularCourse, getPopularList, singlePopularCourse, updatePopularCourse, deletePopularCourse } = require('../controllers/popularCourseController')
const validation = require('../middlewares/validationMiddleware')
const { popularCourseValidation } = require('../validation/schemaValidation')
const popularCourseRouter = express.Router()

// post course
popularCourseRouter.post('/', validation(popularCourseValidation), createPopularCourse);
